...
\node (fission) [forwardfn, align=center, right of =blank, xshift=2cm, yshift=0.75cm] {\large \textbf{Fission}};
\node (tellurium135) [forwardfn, align=center, left of =blank] {\large$^{135}$Te};
\node (iodine135) [forwardfn, align=center, below of =tellurium135, right of =tellurium135] {\large$^{135}$I};
\node (xenon135) [forwardfn, align=center, below of =iodine135, right of =iodine135] {\large$^{135}$Xe};
...
\node (yield) [backwardfn, align=center, right of =tellurium135, xshift=3.2cm, yshift=0cm,]{\large \textbf{6\%}};
\node (beta-te-i) [backwardfn, align=center, right of =tellurium135, xshift=-0.5cm, yshift=-1.2cm] {\large$\beta^-$ \\ \footnotesize $t_{\nicefrac{1}{2}} = 19.0$ s};
\node (beta-i-xe) [backwardfn, align=center, right of =iodine135, xshift=-0.5cm, yshift=-1.2cm] {\large$\beta^-$ \\ \footnotesize $t_{\nicefrac{1}{2}} = 6.6$ h};
\node (beta-xe-cs) [backwardfn, align=center, right of =xenon135, xshift=-0.7cm, yshift=-1cm] {\large$\beta^-$ \\ \footnotesize $t_{\nicefrac{1}{2}} = 9.2$ h};
\node (abs-xe-cs) [backwardfn, align=center, below of =xenon136, xshift=1.6cm, yshift=2.7cm] {\large$\sigma_a \phi$};
